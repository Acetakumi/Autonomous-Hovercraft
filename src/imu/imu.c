...
// Your main loop uses _delay_ms(50) -> 0.05 s.
#define IMU_DT              0.05f

// Small deadzone on gyro rate to kill tiny bias/noise.
...
// Yaw (deg), integrated from gyro Z
...
// ---------- Gyro calibration ----------
// Call this ONCE at startup while the craft is perfectly still.
...
void imu_update(void)
{
    ...
    // Deadzone: ignore tiny rates likely due to noise / residual bias
